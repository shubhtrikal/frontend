...
const Modal_prop = (props) => {
    ...
    const getdata = async () => {
        ...
        let data = await axios.post("https://Classification.devanshkapri1.repl.co/test", info)
        console.log(data);
            ...
            >
                <Box sx={style}>
                    <Typography id="modal-modal-title" variant="h6" component="h2">
                        <img src={props.imgurl} alt="" style={{ height: "150px", width: "150px", alignItems: "center", margin: "auto", width: "100%" }} />
                    </Typography>
